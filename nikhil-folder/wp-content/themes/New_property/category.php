...
<script>
    jQuery(document).ready(function(){
        ...
        jQuery('.details_in').css("padding","46px 18px");
...
?>
  ...
  // echo '<pre>'; print_r($category); echo '</pre>';
    ...
    ?> 
                                   ...
                                   <li><a href="<?php echo get_category_link($id); ?>" <?php if($cat_id == $cat_id_url){echo 'class="new_menu_active"';} ?> ><?php echo $category; ?></a>
                                   <?php
                                        ...
                                        if($row['total_page'] > 0){
                                           ?> 
                                                 <ul class="Developer_menu" <?php if($cat_id == $cat_id_url){echo 'style="display:block"';} ?> >
                    ...
                    <div class="details_in">
                        ...
                        <div class="DataSheet_head">
                            ...
                            // echo '</pre>';
                            ?><?php echo 'ABOUT' . ' ' . get_cat_name($cat_id_url); ?></h1>
                            <p><?php echo category_description($cat_id_url); ?> 
                            </p> 
                        </div>
                                    ...
                                    <ul>
                                        ...
                                        while ($row = mysql_fetch_array($result)) {
                                            ...
                                            while ($fetch_post_title = mysql_fetch_array($result1)) {
                                                ...
                                                ?>  <li><a href="<?php echo get_permalink($id_post); ?>"> <?php echo get_the_post_thumbnail( $id_post , array(100,130));  ?></a></li>
                                                <?php } }
                                            ?>
